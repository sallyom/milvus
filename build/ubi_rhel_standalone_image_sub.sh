...
${PODMAN} build --secret id=${SECRET_NAME},src=${TMPFILE} --network host ${BUILD_ARGS} --platform linux/${IMAGE_ARCH} -f "./build/ubi-rhel/Dockerfile-sub" -t "${MILVUS_IMAGE_REPO}:${MILVUS_IMAGE_TAG}" .
